...
class TestCoreRegistrySingleton:
    ...
    def test_singleton_across_imports(self):
        ...
        from neo_core.core.registry import core_registry as r1
        from neo_core.core.registry import core_registry as r2
        assert r1 is r2
...
class TestCoreRegistryBootstrap:
    ...
    @patch("neo_core.core.memory_agent.MemoryAgent")
    @patch("neo_core.core.brain.Brain")
    @patch("neo_core.core.vox.Vox")
...
class TestCoreRegistryIntegration:
    ...
    def test_daemon_uses_registry(self):
        ...
        assert "from neo_core.cli.chat import bootstrap" not in source

    def test_module_exports(self):
        """Le module core exporte core_registry."""
        from neo_core.core import core_registry
