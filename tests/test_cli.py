...
class TestChatBootstrap:
    ...
    def test_check_installation_not_installed(self):
        ...
        from neo_core.cli.chat import check_installation
        ...
        with patch("neo_core.cli.chat.console"):
...
class TestChatCommands:
    ...
    def test_print_status(self):
        ...
        from neo_core.cli.chat import print_status
        mock_vox = MagicMock()
    ...
    def test_print_health_no_brain(self):
        ...
        from neo_core.cli.chat import print_health
        mock_vox = MagicMock()
        mock_vox.brain = None
        with patch("neo_core.cli.chat.console"):
    ...
    def test_print_skills_no_memory(self):
        ...
        from neo_core.cli.chat import print_skills
        mock_vox = MagicMock()
    ...
    def test_print_persona_no_engine(self):
        ...
        from neo_core.cli.chat import print_persona
        mock_vox = MagicMock()
        mock_vox.memory = None
        with patch("neo_core.cli.chat.console"):
    ...
    def test_print_history_no_session(self):
        ...
        from neo_core.cli.chat import print_history
        mock_vox = MagicMock()
...
class TestSetupUtilities:
    ...
    def test_check_python_version(self, capsys):
        ...
        from neo_core.cli.setup import check_python_version
        import sys
    ...
    def test_check_venv(self):
        ...
        from neo_core.cli.setup import check_venv
        # Ne crash pas
        result = check_venv()
    ...
    def test_run_command_success(self, capsys):
        ...
        from neo_core.cli.setup import run_command
    ...
    def test_save_config(self, tmp_path):
        ...
        import json
        from neo_core.cli.setup import save_config

        config_dir = tmp_path / "data"
        config_file = config_dir / "neo_config.json"
        env_file = tmp_path / ".env"

        with patch("neo_core.cli.setup.CONFIG_DIR", config_dir):
            with patch("neo_core.cli.setup.CONFIG_FILE", config_file):
                with patch("neo_core.cli.setup.ENV_FILE", env_file):
...
class TestStatusModule:
    ...
    def test_import(self):
        ...
        from neo_core.cli import status
...
class TestHealthCheck:
    ...
    def test_global_exception_handler_exists(self):
        ...
        import inspect
        from neo_core.api import server
