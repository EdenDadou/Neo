...
from neo_core.infra.daemon import (
    _read_pid,
    _write_pid,
    _remove_pid,
    _get_pid_file,
...
class TestPidFile:
    ...
    def clean_pid(self, tmp_path):
        ...
        with patch("neo_core.infra.daemon._PID_FILE", tmp_path / ".neo.pid"):
            yield
    ...
    def test_read_pid_no_file(self, tmp_path):
        ...
        with patch("neo_core.infra.daemon._PID_FILE", tmp_path / "nonexistent.pid"):
    ...
    def test_pid_file_creates_parent(self, tmp_path):
        ...
        with patch("neo_core.infra.daemon._PID_FILE", pid_path):
            _write_pid(11111)
    ...
    def test_read_pid_invalid_content(self, tmp_path):
        ...
        with patch("neo_core.infra.daemon._PID_FILE", pid_file):
            assert _read_pid() is None
...
class TestSystemd:
    ...
    def test_install_service_no_sudo(self, tmp_path):
        ...
        with patch("neo_core.infra.daemon._PROJECT_ROOT", tmp_path):
            with patch("neo_core.infra.daemon._DATA_DIR", tmp_path / "data"):
...
class TestDaemonInfra:
    ...
    def test_daemon_module_exists(self):
        """neo_core/infra/daemon.py existe."""
        assert (PROJECT_ROOT / "neo_core" / "infra" / "daemon.py").exists()
