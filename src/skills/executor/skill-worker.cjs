 ...
 *
 * NOTE: Ce fichier utilise .cjs car les Worker Threads Node.js
 * ne supportent pas nativement TypeScript/ESM avec tsx.
 */
...
// Bloquer require pour les skills (mais garder la référence pour ce fichier)
